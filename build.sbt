...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      // Weaver-Test
      "com.disneystreaming" %% "weaver-cats"       % "0.8.1",
      "com.disneystreaming" %% "weaver-discipline" % "0.8.1",
      // optionally (for Scalacheck usage)
      "com.disneystreaming" %% "weaver-scalacheck" % "0.8.1",
      //scalacheck
      ...
      // Ciric
      "is.cir" %% "ciris"            % "3.0.0",
      "is.cir" %% "ciris-enumeratum" % "3.0.0",
      "is.cir" %% "ciris-refined"    % "3.0.0"
    ),
    scalacOptions ++= Seq(
      "-Ymacro-annotations",
